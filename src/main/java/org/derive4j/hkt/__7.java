...
/**
 * Represents a higher order type (or higher kinded type or type constructor) of arity 7.
 ...
 */
public interface __7<f, A, B, C, D, E, F, G> extends __6<__<f, A>, B, C, D, E, F, G> {}
