...
/**
 * Represents a higher order type (or higher kinded type or type constructor) of arity 9.
 ...
 * @param <I> the 9th type parameter of the type constructor
 */
public interface __9<f, A, B, C, D, E, F, G, H, I> extends __8<__<f, A>, B, C, D, E, F, G, H, I> {}
